...
describe('Template Category Delete', () => {
  ...
  it('should disassociate all templates belonging to the template category', () =>
    co(function*() {
      const tmpl1Id = uuid();
      const tmpl2Id = uuid();
      const tmpl3Id = uuid();
      ...
      // Test result
      const actualTmpl1Cat = yield db
        .ref(`/templates/${tmpl1Id}/category`)
        .once('value');
      const actualTmpl2Cat = yield db
        .ref(`/templates/${tmpl2Id}/category`)
        .once('value');
      const actualTmpl3Cat = yield db
  ...
  it('should disassociate all /templatesList belonging to the template category', () =>
    co(function*() {
      const tmpl1Id = uuid();
      const tmpl2Id = uuid();
      const tmpl3Id = uuid();
      ...
      const actualTmpl3Cat = yield db
        ...
        .once('value');
      const actualTmpl1 = yield db
        .ref(`/templatesList/${tmpl1Id}`)
        .once('value');
  ...
  it('should disassociate all /propertyTemplatesList belonging to the template category', () =>
    co(function*() {
      const tmpl1Id = uuid();
      const tmpl2Id = uuid();
      const tmpl3Id = uuid();
