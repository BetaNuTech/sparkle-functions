...
describe('Property Templates Write', () => {
  ...
  it('should remove all property template proxies when a property removes all templates', () =>
    co(function*() {
      const tmplId = uuid();
  ...
  it("should remove a template's property proxies when it is disassociated from a property", () =>
    co(function*() {
      const tmplId1 = uuid();
      const tmplId2 = uuid();
      const propertyId = uuid();
  ...
  it('should update property template proxies when a template is added to a property', () =>
    co(function*() {
      const tmplId1 = uuid();
      const tmplId2 = uuid();
