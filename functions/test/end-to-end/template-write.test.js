...
describe('Templates Write', () => {
  ...
  it('should create property proxies when a template is added', () =>
    co(function*() {
      const tmpl1Id = uuid();
      const tmpl2Id = uuid();
      const tmpl3Id = uuid();
  ...
  it("should remove all a deleted template's property proxies", () =>
    co(function*() {
      const tmplId = uuid();
      const property1Id = uuid();
      const property2Id = uuid();
      ...
      // Assertions
      expect(actual.map(ds => ds.val())).to.deep.equal([
        null,
        null,
        null,
        null,
  ...
  it("should update a template's property proxies with newest data", () =>
    co(function*() {
      const tmpl1Id = uuid();
      const tmpl2Id = uuid();
      const tmpl3Id = uuid();
  ...
  it('should add proxy record to /templatesList after template addition', () =>
    co(function*() {
      const tmplId = uuid();
      const categoryId = uuid();
      const expected = {
  ...
  it('should update proxy record in /templatesList after template update', () =>
    co(function*() {
      const tmplId = uuid();
  ...
  it('should remove proxy record from /templatesList after template deletion', () =>
    co(function*() {
      const tmplId = uuid();
      const categoryId = uuid();
      const beforeData = {
