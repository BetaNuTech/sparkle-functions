...
describe('Property Write', () => {
  ...
  it("should remove a template's property proxies when a template is disassociated from property", () =>
    co(function*() {
      const tmplId1 = uuid();
      const tmplId2 = uuid();
  ...
  it('should upsert template property proxies when a property has template relationships', () =>
    co(function*() {
      const tmplId1 = uuid();
      const tmplId2 = uuid();
