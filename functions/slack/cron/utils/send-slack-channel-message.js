...
const PREFIX = 'slack: cron: utils: send-slack-channel-message:';
 ...
 */
module.exports = async function sendSlackChannelMessage(
  accessToken,
  channelName,
  title,
  message
  ...
  const queryParams = `?token=${accessToken}&channel=${channelName}&text=${slackMessage}`;
