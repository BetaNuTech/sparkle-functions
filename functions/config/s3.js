...
if (!AWS_S3_ACCESS_KEY_ID) {
  console.warn('Warning: "AWS_S3_ACCESS_KEY_ID" not configured for AWS S3 Uploads');
}

if (!AWS_S3_SECRET_ACCESS_KEY) {
  console.warn('Warning: "AWS_S3_SECRET_ACCESS_KEY" not configured for AWS S3 Uploads');
}

if (!AWS_S3_BUCKET_NAME) {
  console.warn('Warning: "AWS_S3_BUCKET_NAME" not configured for AWS S3 Uploads');
}
